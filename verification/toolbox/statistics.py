...
#shift_1_prc = shift_args_xx_percentile(argShift, 'shift_1p', 0.01)
#shift_2_5_prc = shift_args_xx_percentile(argShift, 'shift_2_5p', 0.025)
#shift_5_prc = shift_args_xx_percentile(argShift, 'shift_5p', 0.05)
#shift_95_prc = shift_args_xx_percentile(argShift, 'shift_95p', 0.95)
#shift_97_5_prc = shift_args_xx_percentile(argShift, 'shift_97_5p', 0.975)
#shift_99_prc = shift_args_xx_percentile(argShift, 'shift_99p', 0.99)
