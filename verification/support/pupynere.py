...
class netcdf_file(object):
    ...
    def _write_var_metadata(self, name):
        ...
        if not var.isrec:
            ...
            if vsize > big_int32:
                # vsize is actually redundant, and for variables bigger than 2**31-1 are
                # allowed. A dummy value is then given, after
                # https://www.unidata.ucar.edu/software/netcdf/docs/netcdf/Classic-Format-Spec.html .
                vsize = dummy_vsize
            vsize += -vsize % 4
            ...
            if shape and shape[0] is None:
                ...
                if self.use_mmap:
                    if not shape:
                        ...
                        real_vsize = size*prod(shape) # vsize not reliable if variable bigger than > 2GB.
                    # following line: convert begin_ to python
                    # ints to avoid overflow. JV 2012/8
                    mm = mmap(self.fp.fileno(), int(begin_)+real_vsize, access=ACCESS_READ)
